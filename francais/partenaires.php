...
<head>
    ...
    <title>CASPER | Partenaires Corporatifs</title>
    <link rel="icon" href="../img/isotipo.ico" />
    <link href="../styles/output.css" rel="stylesheet" />
    <meta name="description" content="Découvrez nos partenaires dans le commerce international, leaders dans la production durable de produits agricoles et la commercialisation de produits hydrobiologiques de qualité. Explorez nos solides alliances avec des entreprises de premier plan en Amérique latine et en Afrique.">
    <meta name="keywords" content="partenaires, commerce international, alliances, production agricole, produits hydrobiologiques, qualité, durabilité, entreprise, Amérique latine, Afrique, Almiper, UniOceans">
</head>
        ...
        <div class="mx-auto max-w-screen-xl relative px-4 py-32 lg:flex lg:h-[90vh] lg:items-center">
            <div class="max-w-7xl text-start">
                <h1 class="text-gray-800 bg-clip-text text-3xl sm:text-6xl">
                    Nos <span class="text-orange-600">partenaires</span>
                </h1>
                <p class="mt-4 max-w-xl sm:text-xl">
                    Nous croyons fermement que le succès dans le commerce international repose sur des alliances solides et collaboratives. Nous mettons en avant ici les relations stratégiques que nous avons forgées au fil des ans avec des entreprises leaders et des experts de l'industrie en Amérique latine et en Afrique.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="overflow-hidden bg-white sm:grid lg:grid-cols-2 py-12">
        <div class="p-4 md:p-12 lg:px-16 lg:py-24 order-last lg:order-first">
            <div class="mx-auto max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
                ...
                <p class=" 2 md:mt-4">
                    Entreprise dédiée à la production, la collecte, la transformation et la commercialisation durable de produits agroalimentaires.
                </p>
                <a class="text-orange-600 inline-block font-bold mt-4 transition hover:underline" href="http://www.almiper.com" rel="noreferrer" target="_blank">Visitez leur site web</a>

            </div>
        </div>
        <img alt="Logo de l'entreprise Almiper" src="../img/logo-almiper.webp" height="200" width="200" class="h-100 mx-auto my-auto w-auto object-cover sm:h-80 lg:h-100" />
    </section>
    ...
    <section class="overflow-hidden bg-white sm:grid lg:grid-cols-2 py-12">
        <div class="p-4 md:p-12 lg:px-16 lg:py-24 md:order-last">
            <div class="mx-auto max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
                ...
                <p class=" 2 md:mt-4">
                    Entreprise spécialisée dans la commercialisation de produits hydrobiologiques frais et congelés,
                    transformés selon les normes de qualité et d'innocuité les plus élevées.
                </p>
                <a class="text-orange-600 inline-block font-bold mt-4 transition hover:underline" href="https://unioceans.com.pe/" rel="noreferrer" target="_blank">Visitez leur site web</a>

            </div>
        </div>
        <img alt="Logo de l'entreprise Unioceans" src="../img/unioceans-logo.webp" height="200" width="200" class="h-100 mx-auto my-auto w-auto object-cover sm:h-80 lg:h-100" />
    </section>
