...
<head>
    ...
    <title>CASPER | Corporate Partners</title>
    <link rel="icon" href="../img/isotipo.ico" />
    <link href="../styles/output.css" rel="stylesheet" />
    <meta name="description" content="Discover our partners in international trade, leaders in sustainable production of agricultural products and marketing of high-quality hydrobiological products. Explore our strong alliances with prominent companies in Latin America and Africa.">
    <meta name="keywords" content="partners, international trade, alliances, agricultural production, hydrobiological products, quality, sustainability, company, Latin America, Africa, Almiper, UniOceans">
</head>
        ...
        <div class="mx-auto max-w-screen-xl relative px-4 py-32 lg:flex lg:h-[90vh] lg:items-center">
            <div class="max-w-7xl text-start">
                <h1 class="text-gray-800 bg-clip-text text-3xl sm:text-6xl">
                    Our <span class="text-orange-600">partners</span>
                </h1>
                <p class="mt-4 max-w-xl sm:text-xl">
                    We firmly believe that success in international trade is built on strong and collaborative partnerships. Here, we highlight the strategic relationships we have forged over the years with leading companies and industry experts in Latin America and Africa.
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="overflow-hidden bg-white sm:grid lg:grid-cols-2 py-12">
        <div class="p-4 md:p-12 lg:px-16 lg:py-24 order-last lg:order-first">
            <div class="mx-auto max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
                ...
                <p class="2 md:mt-4">
                    A company dedicated to the sustainable production, collection, processing, and marketing of agricultural products.
                </p>
                <a class="text-orange-600 inline-block font-bold mt-4 transition hover:underline" href="http://www.almiper.com" rel="noreferrer" target="_blank">Visit their website</a>
            </div>
        </div>
        <img alt="Almiper company logo" src="../img/logo-almiper.webp" height="200" width="200" class="h-100 mx-auto my-auto w-auto object-cover sm:h-80 lg:h-100" />
    </section>
    ...
    <section class="overflow-hidden bg-white sm:grid lg:grid-cols-2 py-12">
        <div class="p-4 md:p-12 lg:px-16 lg:py-24 md:order-last">
            <div class="mx-auto max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
                ...
                <p class="2 md:mt-4">
                    A company dedicated to the marketing of fresh and frozen hydrobiological products, processed under the highest standards of quality and safety.
                </p>
                <a class="text-orange-600 inline-block font-bold mt-4 transition hover:underline" href="https://unioceans.com.pe/" rel="noreferrer" target="_blank">Visit their website</a>
            </div>
        </div>
        <img alt="Unioceans company logo" src="../img/unioceans-logo.webp" height="200" width="200" class="h-100 mx-auto my-auto w-auto object-cover sm:h-80 lg:h-100" />
    </section>
