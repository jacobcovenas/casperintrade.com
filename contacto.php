...
<head>
    ...
    <title>CASPER | Contacto</title>
    <link rel="icon" href="./img/isotipo.ico" />
    <link href="./styles/output.css" rel="stylesheet" />
    <meta name="description" content="Contacta con Web Casper para obtener información sobre nuestros servicios de comercio internacional con África. Estamos aquí para responder tus preguntas y brindarte el apoyo que necesitas. Descubre nuestras oficinas, número de contacto y correos de contacto.">
    <meta name="keywords" content="contacto, comercio internacional, África, Web Casper, consultas, preguntas, servicios, oficinas, número de contacto, correos de contacto">
        ...
        <div class="mx-auto max-w-screen-xl relative px-4 py-32 lg:flex lg:h-[90vh] lg:items-center">
            <div class="max-w-7xl text-start">
                <h1 class="text-gray-800 bg-clip-text text-3xl sm:text-6xl">
                    <span class="text-orange-600">Contacta</span> con nosotros
                </h1>
                <p class="mt-4 text-gray-600 max-w-xl sm:text-xl">
                    ¡Nos encantaría escucharte! Si tienes alguna pregunta, comentario o consulta sobre nuestros servicios de comercio internacional con África, no dudes en ponerte en contacto con nosotros. Estamos aquí para ayudarte en todo lo que necesites.
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="block rounded-xl border border-orange-800 p-8 shadow-xl" href="#">
                    ...
                    <h2 class="mt-4 text-xl font-bold text-orange-600">Nuestras Oficinas</h2>

                    <p class="mt-1 text-sm ">
                        Ubicación: Ca. German Schreiber 276 San Isidro Lima - Perú
                    </p>
                </div>
                <div class="block rounded-xl border border-orange-800 p-8 shadow-xl" href="#">
                    <svg class="h-20 w-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h2 class="mt-4 text-xl font-bold text-orange-600">Número de contacto</h2>

                    <p class="mt-1 text-sm ">
                        Central Telefónica: 01 4801041
                    </p>
                    <p class="mt-1 text-sm ">
                        Anexo 1. Gestión Comercial Internacional
                    </p>
                    <p class="mt-1 text-sm ">
                        Anexo 2 Logística y Operaciones Internacionales.
                    </p>
                </div>
                <div class="block rounded-xl border border-orange-800 p-8 shadow-xl" href="#">
                    <svg class="h-20 w-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h2 class="mt-4 text-xl font-bold text-orange-600">Correos de contacto</h2>
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-x-16 gap-y-8 lg:grid-cols-5">
                <div class="lg:col-span-2 lg:py-12">
                    <h2 class="text-gray-800">Planeemos juntos tu proximo proyecto</h2>
                    <p class="lg:max-w-xl mt-8">
                        También puedes enviarnos un mensaje directamente a través de nuestro formulario en línea. Simplemente completa los campos requeridos a continuación y nos pondremos en contacto contigo lo antes posible.
                    </p>
                </div>
                ...
                <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                    <form method="POST" class="space-y-4">
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label class="mb-2 block" for="nombre">Tu Nombre</label>
                                <input required class="input-form" placeholder="" type="text" id="nombre" name="nombre" />
                            </div>
                            <div>
                                <label class="mb-2 block" for="empresa">Nombre de tu Empresa</label>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label class="mb-2 block" for="email">Correo Electrónico</label>
                                <input required class="input-form" placeholder="" type="email" id="email" name="email" />
                            </div>

                            <div>
                                <label class="mb-2 block" for="telefono">Teléfono</label>
                                <input class="input-form" placeholder="" type="tel" id="telefono" name="telefono" />
                            </div>
                        </div>

                        <div>
                            <label class="mb-2 block" for="mensaje">Mensaje</label>
                        ...
                        <div class="flex items-center gap-2">
                            <label class="block-i cursor-pointer" for="politica">Acepta nuestra
                                <a href="./politica-de-privacidad.php" class="text-orange-700 hover:text-yellow-400 underline">Política de privacidad</a>
